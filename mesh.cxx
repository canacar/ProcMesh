...
//---------------------------------------------------------------------------
void
TriMeshLin::markClassDeleted(int cls)
{
	MESH_LOG("Marking class %d as deleted\n", cls);
	...
	MESH_LOG("deleting %d elements\n", size);

	for (int f = 0; f < size; f++)
		markElemDeleted(start + f);
}
//---------------------------------------------------------------------------
int
